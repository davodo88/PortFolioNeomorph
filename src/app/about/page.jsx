    ...
    <section className='flex flex-col gap-y-14 w-full h-full bg-whiteBG dark:bg-gray-900 py-32 dark:text-whiteBG my-auto'>
      <div className='flex flex-col gap-y-10 md:flex-row justify-center items-center w-full h-max p-8'>
        ...
        <div className='flex flex-col justify-center items-center bg-whiteBG dark:bg-gray-900 w-full h-max md:h-full p-6 gap-y-4'>
          <h1 className='flex items-center justify-center text-center w-full font-Montserrat font-bold text-3xl md:text-5xl'>
            DAVID SANCHEZ
          </h1>
          <h3 className='flex justify-center items-center text-center w-full font-semibold font-Lora text-[#427eaf] text-xl'>
            Junior Front-End Developer
          </h3>
          <p className='flex w-full md:w-2/3 mt-4 px-4 font-Hind justify-center items-center text-center text-sm text-gray-600 dark:text-gray-300'>
      ...
      <div className='w-full h-max flex flex-col p-4 rounded text-center font-DancingScript gap-y-5'>
        <h1 className='font-Lora w-32 h-10 font-bold text-3xl text-[#427eaf] m-auto'>
          My Skills
        </h1>
        <SkillsBox />
      </div>
